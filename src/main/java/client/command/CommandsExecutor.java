...
import client.command.commands.gm4.RateCommand;
...
import client.command.commands.gm4.StorageSlotsCommand;
...
public class CommandsExecutor {
    ...
    private void registerLv4Commands() {
        ...
        addCommand("charslots", 4, CharSlotsCommand.class);
        addCommand("storageslots", 4, StorageSlotsCommand.class);
        addCommand("fishrate", 4, FishingRateCommand.class);
        addCommand("rate", 4, RateCommand.class);
